...
!!! info "Copied verbatim from the repository"
    ...
    The gates in `config/gates.yaml` evaluated against the widened n=70 run. Copied verbatim — every caveat below sits in the same cell as the figure it qualifies.
