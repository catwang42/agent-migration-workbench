...
!!! info "Copied verbatim from the repository"
    ...
    The gates in `config/gates.yaml` evaluated against the **deployment configuration**. Incumbent **Claude Sonnet 5 (via Vertex partner models)** <small><code>claude_baseline</code></small>; candidate **Gemini 3.6 Flash (capped thinking)** — reasoning budget minimised — on <small><code>gemini_targeted_v1</code></small> (Query Rewriter), <small><code>gemini_tuned_v1</code></small> (Chunk Summarizer) and <small><code>gemini_optimizer_v1</code></small> (Feature Extractor). The tables below name the model against every arm. Copied verbatim — every caveat sits in the same cell as the figure it qualifies.
    ...
    Times in the artifact below are UTC. In Singapore time:
      ...
      - `2026-08-12T10:30:51+00:00` — 12 Aug 2026, 6:30 PM (SGT)
      - `2026-08-12T12:58:33+00:00` — 12 Aug 2026, 8:58 PM (SGT)
      - `2026-08-12T13:20:51+00:00` — 12 Aug 2026, 9:20 PM (SGT)
