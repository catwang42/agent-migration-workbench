...
!!! info "Copied verbatim from the repository"
    ...
    Every ablation rung and gated arm, per subagent, at the n it was actually run on. Rows are grouped by split because the two splits have different incumbents — never quote a core-28 figure against a full-70 one.
